...
export interface ApiInvestmentInvestment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['pending', 'occupied', 'archived']> &
      Attribute.DefaultTo<'pending'>;
    percent: Attribute.Integer;
    issue_date: Attribute.Date;
    closure_date: Attribute.Date;
    investor: Attribute.Relation<
      'api::investment.investment',
      'manyToOne',
      'api::investor.investor'
    >;
    currency: Attribute.Enumeration<['eur', 'rub', 'usd']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
